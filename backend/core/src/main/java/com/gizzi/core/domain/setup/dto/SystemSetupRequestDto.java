...
public class SystemSetupRequestDto
{
	...
	private String userId;						// 관리자 로그인 ID (4~50자, 영문과 숫자만 허용)
	...
	private String password;					// 관리자 비밀번호 (영문+숫자+특수문자 필수)
	...
	// [ 전화번호 인증 (선택) ]
	//----------------------------------------------------------------------------------------------------------------------
	private String phone;						// 관리자 전화번호 (선택)
	private String phoneVerificationToken;		// 전화번호 인증 검증 토큰 (OTP 인증 성공 시 발급)
}
