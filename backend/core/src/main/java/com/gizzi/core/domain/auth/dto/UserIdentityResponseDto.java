...
public class UserIdentityResponseDto
{
	// [ 필드 ]
	//----------------------------------------------------------------------------------------------------------------------
	private final String        id;					// 연동 PK
	private final String        providerCode;		// 제공자 코드 (google, kakao, naver)
	private final String        providerName;		// 제공자 표시명
	private final String        providerSubject;	// 제공자 측 사용자 고유 키
	private final LocalDateTime linkedAt;			// 연동 일시
