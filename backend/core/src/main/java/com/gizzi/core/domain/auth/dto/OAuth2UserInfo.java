...
public class OAuth2UserInfo
{
	// [ 필드 ]
	//----------------------------------------------------------------------------------------------------------------------
	private final String providerCode;		// 소셜 제공자 코드 (google, kakao, naver)
	private final String providerSubject;	// 소셜 제공자 사용자 고유 키 (sub, id 등)
	private final String email;				// 이메일 주소
	private final String name;				// 사용자 이름 (닉네임)
