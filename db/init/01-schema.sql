...
DROP TABLE IF EXISTS tb_board_admins;
DROP TABLE IF EXISTS tb_board_votes;
DROP TABLE IF EXISTS tb_board_files;
DROP TABLE IF EXISTS tb_board_comment_closure;
DROP TABLE IF EXISTS tb_board_comments;
DROP TABLE IF EXISTS tb_board_post_tags;
DROP TABLE IF EXISTS tb_board_post_closure;
DROP TABLE IF EXISTS tb_board_posts;
DROP TABLE IF EXISTS tb_board_tags;
DROP TABLE IF EXISTS tb_board_categories;
DROP TABLE IF EXISTS tb_board_settings;
...
-- 게시판 설정 (모듈 인스턴스 1:1)
CREATE TABLE tb_board_settings (
...
-- 게시판 카테고리
CREATE TABLE tb_board_categories (
...
-- 게시글 Closure Table (계층형 답글 구현)
CREATE TABLE tb_board_post_closure (
...
-- 게시글-태그 연결 테이블
CREATE TABLE tb_board_post_tags (
...
-- 댓글 Closure Table (계층형 대댓글 구현)
CREATE TABLE tb_board_comment_closure (
